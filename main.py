...
if __name__ == '__main__':
    ...
    raw_y_train_path = path.join(const.INPUT_FOLDER, const.RAW_DATA_FOLDER, const.RAW_TRAIN_FILE_NAME)
    raw_test_path = path.join(const.INPUT_FOLDER, const.RAW_DATA_FOLDER, const.RAW_Y_TRAIN_FILE_NAME)
    ...
    test_set_times = {s.get_series_id(): s.get_last_sti_end_time() for s in test_set.get_sti_series() if
    ...
    for tirp in tirps_list:  # TODO: for debug
    ...
    pred_over_time: dict = {}
    for entity in test_set.get_sti_series():  # TODO: for debug
